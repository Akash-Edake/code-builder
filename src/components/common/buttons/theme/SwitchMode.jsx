...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  "& .MuiSwitch-thumb": {
    ...
    "&:before": {
      ...
      backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" className="onhover" height="20" width="20" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
        "#FEBE10"
